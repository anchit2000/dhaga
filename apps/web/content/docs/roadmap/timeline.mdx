...
description: How Dhaga was built, day by day — a public timeline derived from the project's git commit history, starting 2 July 2026.
---
...
the [roadmap](/docs/roadmap/roadmap) and the
[build checklist](/docs/roadmap/checklist).
...
[roadmap](/docs/roadmap/roadmap); for the exhaustive feature list, the
[build checklist](/docs/roadmap/checklist).
