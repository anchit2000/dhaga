...
- Every one of the extension points in
  [`apps/web/src/lib/hosted/gate/`](https://github.com/anchit2000/dhaga/blob/main/apps/web/src/lib/hosted/gate)
...
[`apps/web/src/lib/ai/metering/dollar-cap.ts`](https://github.com/anchit2000/dhaga/blob/main/apps/web/src/lib/ai/metering/dollar-cap.ts).
...
[Providers](/docs/self-hosting/providers) and `.env.example`. Without
...
instance's dollar ceiling; the per-search charge is not.
...
[`apps/web/src/utils/constants/coming-soon.ts`](https://github.com/anchit2000/dhaga/blob/main/apps/web/src/utils/constants/coming-soon.ts),
and the affordance is
[`apps/web/src/components/app/ComingSoonNotice.tsx`](https://github.com/anchit2000/dhaga/blob/main/apps/web/src/components/app/ComingSoonNotice.tsx).
