    ...
    <div className="max-w-2xl space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-fog">
          ...
          per-user override → promotion → plan allowance → <code>DHAGA_AI_MONTHLY_CAP</code>{" "}
          → free tier. Active grants are added on top of whichever one wins.
        </p>
      </div>

      <EnforcementCard enabled={config.enforcePlanCaps} />
      <PlanAllowanceCard allowances={config.allowances} enforced={config.enforcePlanCaps} />
