...
import { HomeBentoSkeleton, PageHeaderSkeleton, StatStripSkeleton } from "@/components/app/skeletons";
 ...
 * so they render together — while the stat strip (one aggregate count query),
 * the capture dock (all-fast queries), and the onboarding tour each paint
 * without waiting on the dashboard's slow serial chain.
 */
