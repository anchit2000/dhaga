 ...
 *  everywhere at the cost of a one-time model download. */
    ...
    <div className="space-y-4 rounded-2xl border border-seam bg-panel p-5 sm:p-6">
      <div>
        ...
        <p className="mt-1 text-sm text-fog">
          How voice notes and voice search get transcribed. Both keep every
          word on your device — neither ever uploads audio.
        </p>
      </div>
