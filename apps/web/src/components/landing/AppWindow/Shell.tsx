...
export function Shell({
  ...
  return (
    <div
      className={`overflow-hidden rounded-2xl border border-paper/10 bg-gradient-to-b from-panel to-panel-2 shadow-[0_1px_0_rgba(255,255,255,0.06)_inset,0_50px_140px_-30px_rgba(0,0,0,0.9)] ring-1 ring-black/40 ${className}`}
    >
