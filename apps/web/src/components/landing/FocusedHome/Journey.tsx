  ...
  return (
    <section className="border-b border-seam bg-panel/35">
      <div className="mx-auto grid max-w-[1440px] grid-cols-1 px-6 py-10 sm:grid-cols-3 sm:divide-x sm:divide-seam">
        <JourneyStep accent="border-trust/30 bg-trust/10 text-trust" icon={<AudioLines />} number="1" title="Capture anywhere" copy="Send a note, card, or photo from the web, WhatsApp, or Telegram. MCP capture is coming soon." />
