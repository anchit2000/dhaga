...
export function PhoneShell({
  ...
  return (
    <div
      className={`font-ui relative overflow-hidden rounded-[2.4rem] border border-wash/15 bg-ink shadow-[0_1px_0_rgba(255,255,255,0.08)_inset,0_40px_100px_-20px_var(--shadow-cast)] ring-4 ring-black/60 ${className}`}
    >
      {/* dynamic island */}
