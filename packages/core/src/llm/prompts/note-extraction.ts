...
- Set "object_is_named" true when a relationship's "object" is a specific person's name (e.g. "Rohan Iyer"); set it false when the object is only a bare relative or role reference with no name, such as "his son" or "her manager".
